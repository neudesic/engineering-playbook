...
You can use templates like working agreements and such from the [Neudesic Engineering Excellence Playbook](https://github.com/neudesic/engineering-playbook/).
...
This is the landing page of the Documentation website. This is the page to introduce everything on the website.
